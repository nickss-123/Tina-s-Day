/* ===================== DATA ===================== */
// Program participants, transcribed directly from the "Program" sheet
const program = {
  ...
  treasures: ["Renalyn Kaye Gil","Ailish Rain Helera","Jan Pauline Cruz","Mara Clarisse Tayo","Khamille Merciales","Hershey Santos","Noreen Asia Batalla","Nikka Ella Udaundo","Sale Udaundo","Sarah Firman","Imelda dela Cruz","Raquel Brazal"],
  shots: ["Alfred Madriaga","Reymond Edejer","Darwin Gerald Udaundo","Warren Daligdig","John Neslie Leano","Simon Enofre","Virgilio Tibay","Merarie Caballero","Tony Tayo","Renan Cruz","Henry Cabrillas","For update"],
  bills: ["Rem Edejer","Paolo Madriaga","Ranel James Rigo","Aaron Castro","Ryan Rasheed Lazo","Jerum Jerusalem","Mira Inah Caballero","Shane Marie Jalandoni","Gianne Kaye Durante","Veronica Nario","Maricel Gagnao","Brett Pantaleon"]
};
...
function onYouTubeIframeAPIReady(){
  player = new YT.Player('yt-audio', {
    ...
    playerVars:{autoplay:0, loop:1, playlist:'r27t3H36jmU', controls:0},
